    ...
    while (node[i]) {
        ...
        while (rule[j]) {
            ...
            /* Rule elements block */
            {
                ...
                bool negated_regex = false;
                bool negated_match = false;
                bool negated_data = false;
                bool negated_extra_data = false;
                bool negated_hostname = false;
                bool negated_id = false;
                bool negated_location = false;
                bool negated_program_name = false;
                bool negated_protocol = false;
                bool negated_user = false;
                bool negated_url = false;
                bool negated_status = false;
                bool negated_srcport = false;
                bool negated_dstport = false;
                ...
                if (regex) {
                    ...
                    config_ruleinfo->regex->negate = negated_regex;
                ...
                if (match) {
                    ...
                    config_ruleinfo->match->negate = negated_match;
                ...
                if (id) {
                    ...
                    config_ruleinfo->id->negate = negated_id;
                ...
                if (srcport) {
                    ...
                    config_ruleinfo->srcport->negate = negated_srcport;
                ...
                if (dstport) {
                    ...
                    config_ruleinfo->dstport->negate = negated_dstport;
                ...
                if (status) {
                    ...
                    config_ruleinfo->status->negate = negated_status;
                ...
                if (data) {
                    ...
                    config_ruleinfo->data->negate = negated_data;
                ...
                if (extra_data) {
                    ...
                    config_ruleinfo->extra_data->negate = negated_extra_data;
                ...
                if (program_name) {
                    ...
                    config_ruleinfo->program_name->negate = negated_program_name;
                ...
                if (user) {
                    ...
                    config_ruleinfo->user->negate = negated_user;
                ...
                if (url) {
                    ...
                    config_ruleinfo->url->negate = negated_url;
                ...
                if (location) {
                    ...
                    config_ruleinfo->location->negate = negated_location;
                ...
                if(protocol){
                    ...
                    config_ruleinfo->protocol->negate = negated_protocol;
